...
export class AttendanceRegisterComponent implements OnInit {
  displayedColumns: string[] = ['name', 'section', 'flexi_time', 'inTrace', 'outTrace', 'duration_str',  'grace_str', 'grace_left', 'extra_str',  'total_extra_sec','cl_mark_sub', 'comb_mark_sub', 'remarks'];
