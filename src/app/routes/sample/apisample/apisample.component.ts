...
@Component({
  selector: 'app-sample-apisample',
  templateUrl: './apisample.component.html',
  styleUrls: ['./apisample.component.css'],
  standalone: true,
  imports: [PageHeaderComponent, MatButton, MtxGrid]
})
export class SampleApisampleComponent implements OnInit {
